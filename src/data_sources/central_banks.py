...
# Mock implementation
class CentralBankSourceMock(CentralBankSource):
    ...
    async def collect(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fed": {
                "sentiment": "hawkish",
                "latest_statement": "Federal Reserve maintains inflation-fighting stance with rates held steady",
                "rate": 5.5,
                "last_updated": datetime.now(timezone.utc).isoformat()
            },
            "ecb": {
                "sentiment": "neutral",
                "latest_statement": "ECB signals data-dependent approach to future policy decisions",
                "rate": 4.5,
                "last_updated": datetime.now(timezone.utc).isoformat()
            },
            "boe": {
                "sentiment": "dovish",
                "latest_statement": "Bank of England pauses rate hikes as inflation moderates",
                "rate": 5.25,
                "last_updated": datetime.now(timezone.utc).isoformat()
            },
            "boc": {
                "sentiment": "neutral",
                "latest_statement": "Bank of Canada maintains accommodative stance",
                "rate": 5.0,
                "last_updated": datetime.now(timezone.utc).isoformat()
            },
