...
#   embedding:   Float vector of normalized indicator values (1536d)
#   metadata: {
...
class PatternVectorStore:
        ...
        try:
            ...
            try:
                self.collection = self.client.create_collection(
                    ...
                    metadata={"description": "XAUUSD market patterns for RAG-based trading"},
                )
    ...
    def find_winning_patterns(
        ...
        return self.find_similar(indicators, n_results=n_results, filter_outcome="win")
    ...
    def find_losing_patterns(
        ...
        return self.find_similar(indicators, n_results=n_results, filter_outcome="loss")
    ...
    def get_statistics(self) -> dict:
        ...
        for meta in all_data["metadatas"]:
            ...
            total_pnl += float(meta.get("profit_loss", 0.0))
        ...
        return {
            ...
            "strategies_used": sorted(list(strategies)),
