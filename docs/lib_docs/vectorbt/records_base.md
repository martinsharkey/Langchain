...
- MetaRecords 
### field_config property&para;
 
Field config.
 
## MetaRecords class&para;
...
### build_field_config_doc class method&para;
...
### col_arr property&para;
 
Get column array.
 
### col_mapper property&para;
...
` 
### get_apply_mapping_arr method&para;
...
### get_map_field_to_index method&para;
...
### id_arr property&para;
 
Get id array.
 
### idx_arr property&para;
...
### indexing_func_meta method&para;
...
`Config({
 "start": {
 "title": "Start",
 "calc_func": "<function Records.<lambda> at 0x7ff113ff96c0>",
 "agg_func": null,
 "tags": "wrapper"
 },
 "end": {
 "title": "End",
 "calc_func": "<function Records.<lambda> at 0x7ff113ffae80>",
 "agg_func": null,
 "tags": "wrapper"
 },
 "period": {
 "title": "Period",
 "calc_func": "<function Records.<lambda> at 0x7ff113ffaf20>",
...
### override_field_config_doc class method&para;
...
### recarray property&para;
 
### records property&para;
 
Records.
 
### records_arr property&para;
 
Records array.
 
### records_readable property&para;
