...
## ranges_attach_field_config Config&para;
...
` 
## ranges_field_config Config&para;
...
### field_config class variable&para;
...
`Config({
 "start": {
 "title": "Start",
 "calc_func": "<function Ranges.<lambda> at 0x7ff113ff0ea0>",
 "agg_func": null,
 "tags": "wrapper"
 },
 "end": {
 "title": "End",
 "calc_func": "<function Ranges.<lambda> at 0x7ff113ff0f40>",
 "agg_func": null,
 "tags": "wrapper"
 },
 "period": {
 "title": "Period",
 "calc_func": "<function Ranges.<lambda> at 0x7ff113ff0fe0>",
 ...
 "post_calc_func": "<function Ranges.<lambda> at 0x7ff113ff1080>",
 "apply_to_timedelta": true,
 "tags": [
 "ranges",
 "duration"
...
Args
 `column` :&ensp;`str` Name of the column to plot. `top_n` :&ensp;`int` Filter top N range records by maximum duration. `plot_zones` :&ensp;`bool` Whether to plot zones. `ts_trace_kwargs` :&ensp;`dict` Keyword arguments passed to `plotly.graph_objects.Scatter` for Ranges.ts. `start_trace_kwargs` :&ensp;`dict` Keyword arguments passed to `plotly.graph_objects.Scatter` for start values. `end_trace_kwargs` :&ensp;`dict` Keyword arguments passed to `plotly.graph_objects.Scatter` for end values. `open_shape_kwargs` :&ensp;`dict` Keyword arguments passed to `plotly.graph_objects.Figure.add_shape` for open zones. `closed_shape_kwargs` :&ensp;`dict` Keyword arguments passed to `plotly.graph_objects.Figure.add_shape` for closed zones. `add_trace_kwargs` :&ensp;`dict` Keyword arguments passed to `add_trace`. `xref` :&ensp;`str` X coordinate axis. `yref` :&ensp;`str` Y coordinate axis. `fig` :&ensp;`Figure` or `FigureWidget` Figure to add traces to. `**layout_kwargs` Keyword arguments for layout. 
Usage
