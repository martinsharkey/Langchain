...
### Q1 â€” Direction semantics  [STATUS: OPEN]
QUESTION: Is our mapping correct â€” `event_type=deposit` (to exchange) = sell
...
### Q2 â€” The webhook / notification handler  [STATUS: OPEN]
...
### Q3 â€” Predicting WHEN the sale actually executes  [STATUS: OPEN]
QUESTION: After a deposit is credited (sell_window_open), what â€” in your data â€”
...
### Q4 â€” Chunking cadence  [STATUS: OPEN]
...
### Q5 â€” Tape metrics in the raw feed  [STATUS: OPEN]
...
### Q6 â€” Exchange-specific intent  [STATUS: OPEN]
